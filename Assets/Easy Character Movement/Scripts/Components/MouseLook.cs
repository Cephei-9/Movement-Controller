...
namespace ECM.Components
{
	...
	public class MouseLook : MonoBehaviour
	{
		...
		/// <param name="moveByTransform"></param>
		public virtual void LookRotation(CharacterMovement movement, Transform cameraTransform, Vector2 rotateVector,
			bool moveByTransform)
		{
			var yaw = rotateVector.x * lateralSensitivity;
			var pitch = rotateVector.y * verticalSensitivity;
			...
			{
				if (moveByTransform)
					movement.transform.rotation *= yawRotation;
				else
